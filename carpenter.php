...
<body>
    ...
    <div class="container-fluid yellow-section">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2 class="text-center font-weight-bold">Carpenter</h2>
                <img class="service-img" src="images/carpenter-2.png" alt="plumbing image">
            </div>
            <div class="col-lg-6">
...
if($contactcount==0){
      ?>
        ...
        <script>
                   location.replace("carpenter.php");
                </script>
        <?php
         
   }else{
   
   $insertquery = "insert into carpenter (Name, Mobile ,Address , Date, Time , Issue
      ...
      if($iquery){
                   ...
                   $body = "Hi this is ezLife Care. Click here to check your reciept details: 
                       http://localhost/MAJOR/carpreceipt.php";
             ...
             ?>
                ...
                <script>
                   location.replace("carpreceipt.php");
                </script>
