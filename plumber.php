...
<body>
    ...
    echo '<nav id="nav" class="yellow-section navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" id="logo-txt" href="index.php">ezLife.in</a>
    ...
    <div class="container-fluid yellow-section">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2 class="text-center font-weight-bold">Plumber</h2>
                <img class="service-img" src="images/plumber-2.png" alt="plumbing image">
            </div>
            <div class="col-lg-6">
                <h3 class="text-center font-weight-bold">Book Your Service</h3>
                <div class=" form-display yellow-section">
                        <form action="plumber.php" method="post">
...
if($contactcount==0){
       ?>
         ...
         <script>
                    location.replace("plumber.php");
                 </script>
         <?php
          
    }else{
    
    $insertquery = "insert into plumber (Name, Mobile ,Address , Date, Time , Issue
                 ) values( '$username' , '$contact' , '$address','$date','$time','$description')";
       
       $iquery = mysqli_query($con, $insertquery);
       
       $email=" SELECT Email from registration ORDER BY id DESC LIMIT 1 ";
       
       if($iquery){
                     $email =  $_SESSION['Email'];
                    $subject = "SERVICE DETAIL";
                    $body = "Hi this is ezLife Care. Click here to check your reciept details: 
                        http://localhost/MAJOR/plumreceipt.php";
                    $sender_email = "From: care.ezlife@gmail.com";
                    
                    if (mail($email, $subject, $body, $sender_email)) {
                    $_SESSION['msg'] = "Your service has been booked $email";
                    } else {
              ...
              ?>
                 ...
                 <script>
                    location.replace("plumreceipt.php");
                 </script>
             ...
             ?>
                 <script>
                    alert("Error:  Please Use Registered Mobile Number");
                 </script>
