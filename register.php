...
if(isset($_POST['submit'])){
    ...
    if($emailcount>0){
       ...
       $insertquery = "insert into registration( Name,Mobile,Address,Email,Password,token,status ) 
                         values('$username', '$mobile', '$address', '$email', '$pass' , '$token' , 'inactive' )";
       ...
       if($iquery){
            ...
            $body = "Hi this is ezlife care. Click here to verify your account: 
                     http://localhost/MAJOR/activation.php?token=$token";
